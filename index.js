...
/////////////////
const BotName = 'Friday'; 
const instagram = 'Xensasin'; 
const telegram = 'no telegram'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/channel/UCIxIouO3CCd5zJfYo7Ogiyw';
//const grupch1 = 'belum ada grup'; no grup is private
const
{
   WAConnection,
   MessageType,
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@xenxasin`)
})
